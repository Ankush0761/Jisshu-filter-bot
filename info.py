...
BOT_TOKEN = environ.get('BOT_TOKEN', '7742043816:AAH6RTs3ba3Akc1UYZ8RpUaxX4NVKwgT-Bw')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002690331078'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/JisshuMovieZone')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002666962918').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://dbarun326:F8wYCAD0YmgHu6AX@cluster0.lrzbqc3.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','0'))# set shortner log channel
